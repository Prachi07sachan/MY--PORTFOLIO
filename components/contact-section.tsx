                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      ...
                      <span>prachisachan25@gmail.com</span>
                    </div>
                    <div className="flex items-center">
                      <Phone className="h-5 w-5 text-primary mr-3" />
                      <span>+91 87696305233</span>
                    </div>
                    <div className="flex items-center">
                  ...
                  <div className="pt-6">
                    ...
                    <div className="flex space-x-4">
                      <motion.a
                        href="https://github.com/Prachi07sachan"
                        target="_blank"
                      ...
                      <motion.a
                        href="https://www.linkedin.com/in/prachi-sachan-5ba852253/"
                        target="_blank"
                        rel="noopener noreferrer"
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                  ...
                  <div className="pt-6 border-t border-border">
                    <p className="text-sm text-muted-foreground">
                      ...
                      full-time opportunities, and collaboration on exciting Web
